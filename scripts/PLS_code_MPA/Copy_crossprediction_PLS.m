...
%% Threshold bootstapped maps 

% unc
% FDR-corr

% Moved to separate script in scripts/prep_threshold_bootmaps
...
% ---------------------------------------------------------------------------------
%% I think this is where the error happened:
% this is working on the same bs_stat from the previous loop (so,
% technically, on the fdr-corr. bs_stat)
% ---------------------------------------------------------------------------------
