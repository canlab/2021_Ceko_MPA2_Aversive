sfunction [han, X, Y, slope_stats] = line_plot_multisubject(X, Y, varargin)
...
if group_avg_ref_line
    ...
    han.grpline_handle = plot([minX maxX], [avg_b(1)+avg_b(2)*minX avg_b(1)+avg_b(2)*maxX], 'Color', 'k', 'LineWidth', 2);
end
